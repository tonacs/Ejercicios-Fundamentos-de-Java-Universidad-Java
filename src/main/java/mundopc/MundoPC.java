...
//Ejemplo realizado por Ubaldo en el curso de Universidad Java 
//Primer laboratorio Java
public class MundoPC {

    public static void main(String args[]) {

        //creacion de computadora Toshiba
        Monitor monitor1 = new Monitor("Dell", 30);
        Teclado teclado1 = new Teclado("Bluetooth", "Toshiba");
        Raton raton1 = new Raton("bluetooth", "Toshiba");
        Computadora compuToshiba = new Computadora("Computadora Toshiba", monitor1, teclado1, raton1);
        ...
        Computadora compuArmada = new Computadora("Computadora Armada", monitorDell, teclado1, raton1);
